...
### v0.2 — Контент 🚧
*База, без которой ничего не работает: задачи, материалы и способы их решать.*

- [ ] Парсинг заданий через [`sdamgia-api`](https://github.com/anijackich/sdamgia-api)
- [ ] Кэширование задач в собственной БД (схема + индексы)
...
*Поверх контента — мозг бота. Решаем не наобум, а по алгоритму.*
...
### v0.4 — UX-полировка
*Когда уже всё работает, делаем красиво.*
